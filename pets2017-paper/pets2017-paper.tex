...
We recruited people from Craigslist using the recruitment text in Appendix~\ref{qualitative-recruitment}, which linked an online survey that collected demographics. We pre-screened~\cite{screening} to ensure diversity of gender, age, technical expertise, and (self-reported) familiarity with Tor in a small participant pool. The pre-screening survey is in Appendix~\ref{qualitative-prescreening}.
