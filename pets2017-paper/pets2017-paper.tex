...
\item {\bfseries Used the bridges auto-responder incorrectly (2/21).} P96, P111, who were in E3, emailed the bridges auto-responder to get custom bridges. However, they formatted the message incorrectly and thus failed to get a response (Appendix~\ref{failed-participants}).
\end{description}
