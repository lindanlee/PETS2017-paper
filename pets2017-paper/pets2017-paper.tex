...
We qualify where the interface is not usable with user observations 
and quantify how unusable the interface is with user interaction logs. 
Based on what we learned, we recommend some changes that 
we believe will help users connect to Tor in censored environments. 
We conclude by starting a discussion on alternative 
