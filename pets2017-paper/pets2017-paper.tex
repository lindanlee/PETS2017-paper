...
\item some recommendations to improve the interface
\end{itemize}
...
%Tor version~4.5 incorporated textual and navigational changes based on our redesigned interface.
}
