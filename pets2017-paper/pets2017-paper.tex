...
We define the time participants not on the progress screen as the amount of time they actively spent configuring their connection. This is a simplified notion the time participants spent configuring, since some participants waited at the progress screen without doing anything while others searched for help on the web while they were waiting. However, participants with the new and old interface were equally likely to exhibit this behavior. Participants with the new interface showed a statistically significant reduction in the overall time configuring the interface (Mann-Whitney W = 997, p-value = 0.0001571). 
