...
5 Participants downloaded Tor Browser:  P115 (Fig.~\ref{softonic}), P116 (Fig.~\ref{techspot}), P117, data not used (Fig.~\ref{mirror}), P118, data not used (Fig.~\ref{downloadio}), and P119, data not used (Fig.~\ref{driverupdate}).
...
\caption{P115 downloaded Tor Browser from Softonic, a reputable-looking but
unconfirmed site.}
\label{softonic}
\end{figure}
