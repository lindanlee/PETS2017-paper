...
A summary about what we have seen in E1. Just put the high level takeaways so 
that people don't really need to read the summaries. Observations in E1: 

%P2(regular): E1 (~1:52) 
\pquote{P1 (success, connection time, configuration time)}{summary of what they did here.}

%P3(regular): E1 (N/A; lost chunk of video… but ~1 minute) 
\pquote{P2 (success, connection time, configuration time)}{summary of what they did here.}

%P4(regular): E1 (~4:30)
\pquote{P3 (success, connection time, configuration time)}{summary of what they did here.}

%P9 (regular): E1 (~0:45)
\pquote{P4 (success, connection time, configuration time)}{summary of what they did here.}

%P10 (has used Tor before): E1 (GET TIME)
\pquote{P5 (success, connection time, configuration time)}{summary of what they did here.}

A summary about what we have seen in E2. Just put the high level takeaways so 
that people don't really need to read the summaries. Observations in E2: 

%P7 (heard of Tor): E2 (~4:30) 
\pquote{P6 (success, connection time, configuration time)}{summary of what they did here.}

%P8 (used Tor): E2 (clock drift mission impossible, never succeeds) 
\pquote{P7 (success, connection time, configuration time)}{summary of what they did here.}

%P11 (used Tor before): E2 (~3:00)
\pquote{P8 (success, connection time, configuration time)}{summary of what they did here.}

%P12 (regular): E2 (GET TIME)
\pquote{P9 (success, connection time, configuration time)}{summary of what they did here.}

%P13 (regular): E2 (GET TIME) 
\pquote{P10 (success, connection time, configuration time)}{summary of what they did here.}

A summary about what we have seen in E3. Just put the high level takeaways so 
that people don't really need to read the summaries. Observations in E3: 

%P1 (heard of tor before): E3 (~8:30) 
\pquote{P11 (success, connection time, configuration time)}{summary of what they did here.}
