...
To help users decide what to do, we label the configure button as an option heavily censored environments, tell users to configure a bridge if Tor is censored, and give a secondary bridge recommendation.
