...
censorship circumvention tool. We believe that this is a great opportunity for user research, both for investigating a case study of how users circumvent censorship, but also to help Tor users circumvent censorship more easily and provide them with extra security features, such as anonymity. Not only does improving the interface help the user trying to circumvent censorship, it helps other users who use Tor as an anonymity system by increasing the number of overall users~\cite{dingledine2006anonymity}. 
