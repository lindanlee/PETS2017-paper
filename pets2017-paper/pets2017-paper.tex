...
We designed the environments to be representative important real-world
cases of censorship, but they do not imitate any particular censorship environment.
...
{\color {red} TODO: REDO THIS PARAGRAPH COMPLETELY}
...
\item {\bfseries Added guidance on choosing to connect or configure.} We labeled the configure option specifically for user in heavily censored environments, to urge users in mild censorship environments to try a direct connection.
...
\item {\bfseries Only tried recommendations (6/21): P91, P92, P95, P110, P113, P116} These participants in E3 did not know what to do next after a direct connection and a default obfs3 bridge connection. They often tried those configurations again or gave up. 
