...
\subsection{Results} 
Out of our 124 participants,  we have 116 valid data points. {\color {red} TODO} participants downloaded their own version of Tor, and {\color {red} TODO} participants did not sign the consent form. We have 58 valid participants who tested the new interface, and 58 who tested the old interface. 38 participants were in E1, 38 participants were in E2, and 40 participants were in E3. Table~\ref{table:participant-summary} summarizes participants' success based on their interface version and environment combination. 

The impact of the version on success rate is (significant,not significant). 
The impact of the environment on success rate is (significant,not significant). 
% SUCCESS
...
Talk about why we chose to assign the max time of 40 minutes to did not finish. 
The impact of the version on time to completion is (significant,not significant). 
The impact of the environment on time to completion is (significant,not significant).
...
\centering
	...
	E1-OLD & 19/19 & 100\% & 1:05 \\ %medians of only finished: 1:01
	E2-NEW & 18/19 & 95\% & 3:22 \\ %medians of only finished: 3:22
	E2-OLD & 16/19 & 84\% & 5:07 \\ %medians of only finished: 3:13
	E3-NEW & 13/20 & 65\% & 22:19 \\ %medians of only finished: 12:38
...
failed to connect successfully were assigned success time for 40 minutes.}
...
The impact of the version on active time is (significant,not significant). 
The impact of the environment on active time is (significant,not significant).
...
New people still spent time configuring their proxy!  

% impacts of making bridge page collapsed 
This is unclear. 

% impacts of giving people advice on which transport to choose.
10 people in the new interface chose meek as their second bridge (10/15, 66\%). 
5 people in the old interface chose meek as their second bridge (5/13, 38\%). 
...
%FAILURES
Elaborate on why people failed:  
\begin{enumerate}
\item only tried connecting directly (8/23)
\item didn't know what to do after connecting directly and default bridge (6/23)
\item Thought that they needed a proxy (6/23)
\item used the bridges auto-responder incorrectly (3/23)
\end{enumerate} 
...
Mention of people downloading their own Tor. 
