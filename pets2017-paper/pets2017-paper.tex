...
Thought that they needed a proxy: 
\begin{enumerate}
...
Only tried connecting directly: 
\begin{enumerate}
...
Didn't know what to do after connecting directly and default bridge: 
\begin{enumerate}
...
Failed to use the bridges@torproject.org autoresponder: 
\begin{enumerate}
...
Participants that downloaded Tor: 
\begin{enumerate}
