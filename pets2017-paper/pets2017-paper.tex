...
We first examined tasks required, inputs taken, and consequences of possible actions on each screeen to map all potential paths through the interface (Figure~\ref{fig:digraph}). We then stepped through each user path, systematically toggling all actions and inputs. 
...
This section discusses our small-scale, qualitative usability evaluation and resulting user insights. 
...
This section discusses our large-scale quantitative usability evaluation and resulting user measurements. 
