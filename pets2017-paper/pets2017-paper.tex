...
\begin{itemize}
\item {\bfseries Difficult tasks:} The interface uses technical and Tor-specific terms that are likely to be unfamiliar to an average user, such as the Tor network, internet service provider (ISP), local proxy, bridges, and transports. 
