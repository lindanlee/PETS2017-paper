...
And although some users in our qualitative study tried to configure unnecessary components, we still also allow all users to choose a manual configuration to give them a chance to connect to Tor securely the first time. 
