...
% Format a participant quotation. It should be inside a quotation environment.
\newcommand{\pquote}[2]{
\begin{quotation}
\noindent #1:~\textit{``#2''}
\end{quotation}
...
Tor Browser~5.0.3, which was the current stable release at the time we began.
...
%how much time participants in aggregate spent in progress bar 
overall, participants spent 65\% of their time in the progress bar. 
e1 participants spent 28\% of their time in the progress bar. 
e2 participants spent 74\% of their time in the progress bar. 
e3 participants spent 63\% of their time in the progress bar. 
new participants spent 78\% of their time in the progress bar. 
old participants spent 57 \% of their time in the progress bar. 

% how much time participants spent on average would be nice. (maybe I can do this later). 
%	i.e. the average participant in e1 spent x\% of their time in the progress bar. 

% overall time spent configuring a proxy
overall, participants spent 18\% of their overall time configuring a proxy. 
e1 participants spent 16\% of their overall time configuring a proxy. 
e2 participants spent 10\% of their overall time configuring a proxy. 
e3 participants spent 21\% of their overall time configuring a proxy.  
new participants spent 7\% of their overall time configuring a proxy.  
old participants spent 25 \% of their overall time configuring a proxy. 

% ``active'' time spent configuring a proxy
overall, participants spent 52\% of their active time configuring a proxy. 
e1 participants spent 22\% of their active time configuring a proxy. 
e2 participants spent 40\% of their active time configuring a proxy. 
e3 participants spent 57\% of their active time configuring a proxy.  
new participants spent 31\% of their active time configuring a proxy.  
old participants spent 58\% of their active time configuring a proxy.

% how much time participants spent on average during their ``active time'' would be nice (maybe I can do this later). 
% 	i.e. the average participant in new spent x\% of their active time configuring a proxy. 

% impacts of adding in a summary page 
adding in a summary screen causes people to think about their configuration.
summary to bridge settings: 13 \% (15/119)
summary to progress: 86 \% (102/119)
summary to summary: 1 \% (2/119)

%%% SUCCESS RATE 
% TODO: impact of env on success (chi squared?.. Serge might be wrong on this) 
% TODO: impact of version on success (chi squared?.. Serge might be wrong on this) 

%%% RIGHT CLAMP TIME 
% done
% TODO:  impact of env on time to success 
% TODO: impact of version on time to success 

%%% RIGHT CLAMP ACTIVE TIME 
% TODO:  time to success graph with right clamped ``active time''
% TODO:  impact of env on time to success 
% TODO: impact of version on time to success 


% basic statistics (BAD, NEED CHI SQUARED NOT KRUSKAL AND EXCLUDED DNFs)
...
% looking at all factors' impact on success rate (SUCCESS RATHER THAN SUCCESS RATE?)
...
% looking at all factors' impact on time to completion (BAD, EXCLUDED DNFs)
...
\centering
	...
	\end{tabular}
\caption{A summary of participants' success in circumventing censorship
...
Here, non-finishing participants are assigned the maximum time of 40 minutes.
}
