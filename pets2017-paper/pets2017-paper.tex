...
We recruited users from Craigslist using the recruitment text in Appendix~\ref{qualitative-recruitment}. 
The recruitment posting linked an online survey that collected their demographics, technical expertise, and familiarity with Tor.   
...
We distributed participants so that each experimental condition had at least one person who has never heard of Tor, at least one person who has only heard of Tor, and one person who has previously used Tor. The complete prescreening survey can be found in Appendix~\ref{qualitative-prescreening}.
}
