...
p <- p + annotate(geom="text", x=c(1), y=c(0.86), label=c("E1-\nNEW"), hjust=1, vjust=0, size=2, lineheight=0.8)
p <- p + annotate(geom="text", x=c(3.3, 14, 15.3, 23, 24.7), y=c(0.87, 0.91, 0.71, 0.61, 0.32), label=c("E1-OLD", "E2-NEW", "E2-OLD", "E3-NEW", "E3-OLD"), hjust=0, vjust=0, size=2)
p <- common_theme(p)
