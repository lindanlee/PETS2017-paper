...
\subsection{Results} 
The possible interface version and environment combinations resulted in 6 experimental conditions. We recruited 124 participants to aim for about 20 participants per condition. We filtered participants who did not use our instrumented version of Tor Browser or did not sign the consent form, resulting in 116 participants. Table~\ref{table:participant-summary} summarizes the rate of success, time to success, and active time for our participants' by condition. 
...
%(Mann--Whitney $Z = -1.84$, $p = 0.0328$, $r= 0.172$)
...
\item {\bfseries Used the bridges auto-responder incorrectly (2/21).} P96, P111, who were in E3, emailed the bridges auto-responder to get custom bridges. However, they formatted the message incorrectly and thus failed to get a response (Appendix~\ref{custom}).
\end{description}
...
\item {\bfseries Users try the easy path first.} Users generally try connecting directly to the Tor network first. 81\% (94 of 116) of first attempts were to connect directly, with 53\% (50 of 94) direct first attempts from the new interface and 47\% (44 of 94) direct first attempts from the old interface. This leaks to network eavesdroppers that they are connecting to Tor.
