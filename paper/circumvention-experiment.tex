...
using it as once, since Tor's role as a proxy to anonymize
...
prototypes.We collected feedback from researchers, professors, and Tor users and developers
...
\ref{fig:redesign-firstscreen}, which has
...
\noindent {\bfseries Looking Forward} We will help incorporate changes into the Tor browser. Since we have developer support, it is not expected that we implement our changes, but we will advise them on any changes that they make. We hope that our work is able to help people more easily access the free Internet. 
