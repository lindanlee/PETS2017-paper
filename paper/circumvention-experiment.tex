...
\begin{itemize} \itemsep1pt \parskip0pt \parsep0pt
\item {\bfseries Test the Tor configuration interface} 
\item {\bfseries Test an improved configuration interface} 
\item {\bfseries Test an alternative configuration interface} 
\item {\bfseries Push changes} 
\end{itemize}
